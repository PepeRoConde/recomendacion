...
def load_and_build_matrix_R(path, quick=False, max_files=5, test_playlists_path=None):
    """
    ...
    if test_playlists_path:
        with open(test_playlists_path, encoding="utf-8") as f:
